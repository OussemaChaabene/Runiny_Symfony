 ...
 */
final class Version20220420233039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carac_sport (id INT AUTO_INCREMENT NOT NULL, user INT DEFAULT NULL, taille INT NOT NULL, poids INT NOT NULL, prot_needs INT DEFAULT NULL, calorie_need INT DEFAULT NULL, age INT DEFAULT NULL, INDEX fk_carac_user (user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
